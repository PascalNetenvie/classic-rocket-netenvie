            ...
            {if $product.description}
                <li class="nav-item">
                    <span
                            ...
                            {if $product.description} aria-selected="true"{/if}>{l s='Description' d='Shop.Theme.Catalog'}</span>
                </li>
            {/if}
            <li class="nav-item">
                <span
                        ...
                        {if !$product.description} aria-selected="true"{/if}>{l s='Product Details' d='Shop.Theme.Catalog'}</span>
            </li>
            {if $product.attachments}
                <li class="nav-item">
                    <span
                            ...
                            href="#attachments"
                            role="tab"
                            aria-controls="attachments">{l s='Attachments' d='Shop.Theme.Catalog'}</span>
                </li>
            {/if}
            {foreach from=$product.extraContent item=extra key=extraKey}
                <li class="nav-item">
                    <span
                            ...
                            href="#extra-{$extraKey}"
                            role="tab"
                            aria-controls="extra-{$extraKey}">{$extra.title}</span>
                </li>
            {/foreach}
        </ul>
